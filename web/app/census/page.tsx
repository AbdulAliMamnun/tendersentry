...
export const metadata: Metadata = {
  title: "The Ontario Tender Access Census — TenderSentry",
  description:
    "The first public map of where Ontario's municipal tenders are published: all " +
    "444 municipalities, by platform and by population.",
};
    ...
    <>
      ...
      <main className="shell py-14">
        ...
        <header className="max-w-3xl">
          <p className="eyebrow">The Ontario Tender Access Census · July 2026</p>
          <h1 className="mt-5 text-[30px] font-semibold leading-[1.2] sm:text-[34px]">
            Where Ontario&rsquo;s tenders actually live
          </h1>
          <p className="mt-5 text-[15px] leading-relaxed text-body">
            This is the first public map of how every one of Ontario&rsquo;s 444
            municipalities publishes its tenders, built by surveying each
            municipality&rsquo;s own website. More than half of Ontarians live in a
            municipality whose tenders sit behind a single private platform, and under
            1% live in one that posts its tender documents openly.
          </p>
        </header>
